...
test('correct todolists should be created', () => {
  const title = 'New todolists'
...
test('correct todolists should change its title', () => {
...
test('correct todolists should change its filter', () => {
